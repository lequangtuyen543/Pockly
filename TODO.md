...
- [ ] Thiết kế UI Prototypes (Figma / Stitch) cho các màn hình chính.
- [ ] Viết tài liệu tổng quan (`docs/01-project-overview.md`).
...
- [ ] Viết tài liệu luồng hệ thống: nhập liệu → lưu → thống kê → cảnh báo (`docs/05-system-flow.md`).
...
- [ ] Khởi tạo project Express với TypeScript (`tsconfig.json`, `nodemon`).
